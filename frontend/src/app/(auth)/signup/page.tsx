  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="font-display text-3xl font-bold text-[#1f3027]">Get Started</h1>
      ...
      <div className="mt-6 text-center">
        <p className="text-[11px] text-[#8ca1c5]">
          ...
          <Link href="/login" className="font-bold text-[#3c9f95] hover:text-[#2d7a72] transition-colors">
            Sign In
          </Link>
        </p>
      </div>
